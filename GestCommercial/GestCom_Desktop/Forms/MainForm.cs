using Serilog;
using GestCom_Desktop.Forms.Admin;
using GestCom_Desktop.Forms.BonsLivraison;
using GestCom_Desktop.Forms.BonsReception;
using GestCom_Desktop.Forms.Clients;
...
public class MainForm : Form
{
    ...
    public MainForm()
    {
        Text = $"GestCom — {AppHost.Session.Login}";
        IsMdiContainer = true;
