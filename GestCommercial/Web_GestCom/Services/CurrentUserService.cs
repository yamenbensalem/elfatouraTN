...
/// L'interface <see cref="ICurrentUserService"/> vient de Web_GestCom.Core (partagée avec
/// GestCom_Desktop, qui fournit sa propre implémentation non-HTTP) — seule cette implémentation
