...
/// the host is a Blazor Server circuit (CurrentUserService in Web_GestCom, HTTP-backed)
/// or a WinForms desktop session (DesktopCurrentUserService in GestCom_Desktop, set once
